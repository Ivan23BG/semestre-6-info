...
//
// fermeture.cpp : Dilate une image en niveau de gris puis erode le resultat
...
int main(int argc, char *argv[]) {
    ...
    // dilatation
    dilatation(ImgIn, ImgTmp, nH, nW, cNomImgTmp);
    // erosion
    erosion(ImgTmp, ImgOut, nH, nW, cNomImgEcrite);
