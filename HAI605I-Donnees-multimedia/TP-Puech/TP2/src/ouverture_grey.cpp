...
//
// ouverture_grey.cpp : Dilate une image en niveau de gris puis erode le resultat
...
int main(int argc, char *argv[]) {
    ...
    // dilatation
    erosion_grey(ImgIn, ImgTmp, nH, nW, cNomImgTmp);
    // erosion
    dilatation_grey(ImgTmp, ImgOut, nH, nW, cNomImgEcrite);
